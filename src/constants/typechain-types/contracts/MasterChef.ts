...
export interface MasterChefInterface extends utils.Interface {
  functions: {
    ...
    "manaPerBlock()": FunctionFragment;
    "massUpdatePools()": FunctionFragment;
    "owner()": FunctionFragment;
    "pendingMana(uint256,address)": FunctionFragment;
...
export interface MasterChef extends BaseContract {
  ...
  functions: {
    ...
    manaPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    manaPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
